...
const PropertyCard = ({
    ...
    return (
        <Link href={`/${slug}`}>
            <div className="flex flex-col space-y-3 shadow-md border border-white hover:shadow-xl transition duration-100 cursor-pointer rounded xl:w-[21.4vw] xl: h-[50vh]">
