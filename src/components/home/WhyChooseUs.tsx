...
const WhyChooseUs = () => {
    return (
        <div className="w-full h-[42vh] bg-cover bg-no-repeat bg-center relative flex items-center justify-center"
            ...
            <div className="absolute w-3/5 bg-white shadow-lg flex items-center space-x-4 z-50  h-52 top-[65%] py-8 px-4 spcae-x-5">
                {
